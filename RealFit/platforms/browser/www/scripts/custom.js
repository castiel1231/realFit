$(document).ready(function () {   
    ...
    function init_template(){
        ...
        $('.submenu .menu-item').append("<i class='ion-ios-arrow-right'></i><i class='ion-record'></i>");
        
        //Sidebar Dimensions Go here 
        var sidebar_width = 260; 
        var sidebar_scale = 0.9;
        var sidebar_shadow_correction = 260; /*Add 30 Pixels to your sidebar width*/
        var sidebar_form_width = sidebar_width - 20;  /*This calculates the form size automatically*/
        ...
        $('.open-left-sidebar').click(function(){
            ...
            $("#page-content").css({
                "transform": "translateX("+sidebar_width*(1)+"px) scale("+sidebar_scale+")", 
                "-webkit-transform": "translateX("+sidebar_width*(1)+"px) scale("+sidebar_scale+")", 
                "-moz-transform": "translateX("+sidebar_width*(1)+"px) scale("+sidebar_scale+")", 
                "-o-transform": "translateX("+sidebar_width*(1)+"px) scale("+sidebar_scale+")", 
                "-ms-transform": "translateX("+sidebar_width*(1)+"px) scale("+sidebar_scale+")"
            });
            return false;
        });
      ...
      var options = {
        ...
        onStart: {
          ...
          render: function ($container) {
            ...
            $('.sidebar-tap-close').removeClass('active-tap-close'); 
              setTimeout(function(){
                $('.fade-effect').addClass('active-fade-effect');
              },150);
            $("#page-content").css({
                "transform": "translateX(0px)", 
                "-webkit-transform": "translateX(0px)", 
        ...
        onAfter: function($container, $newContent) {
            ...
            $('.fade-effect').removeClass('active-fade-effect');
